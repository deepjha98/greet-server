...
function show_usage()
{
	...
	echo "-----"
	echo
	echo "  SERVER_URL=https://my.precisely-demo.org:4443 ROOM_ID=test MEDIA_FILE=./test.mp4 ./ffmpeg.sh"
	echo
	echo "  where:"
...
# creation above. Also, tell ffmpeg to send the RTP to the precisely
